...
<head>
    <meta charset="utf-8">
    <link href="{{ asset('Rubickv4.0.5') }}/Source/dist/images/logo.svg" rel="shortcut icon">
...
<body class="login">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    <img alt="Midone - HTML Admin Template" class="-intro-x w-1/2 -mt-16"
                        src="{{ asset('Rubickv4.0.5') }}/Source/dist/images/illustration.svg">
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="intro-x flex text-slate-600 dark:text-slate-500 text-xs sm:text-sm mt-4">
                            <div class="flex items-center mr-auto">
                                <input class="form-check-input border mr-2" type="checkbox" name="remember"
                    ...
                    <div class="intro-x mt-10 xl:mt-24 text-slate-600 dark:text-slate-500 text-center xl:text-left">
                        By signing up, you agree to our <a class="text-primary dark:text-slate-200" href="">Terms
    ...
    <link rel="stylesheet" href="{{ asset('Rubickv4.0.5') }}/Source/dist/js/app.js">
</body>
